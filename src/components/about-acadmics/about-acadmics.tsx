...
import {
    ABOUT_ACADMIC_TIMELINE,
    ABOUT_ACADMIC_TIMELINE_OPTIONS,
} from '../../mocks'
        ...
        <Stack direction="row" justifyContent="space-between">
            ...
            <Timeline position="left" sx={SX.Container}>
                {ABOUT_ACADMIC_TIMELINE?.map((item, i) => {
                    const args = {
                        isLastEl:
                            ABOUT_ACADMIC_TIMELINE_OPTIONS?.length - 1 !== i,
                        isMidEl: !!(
                            i && ABOUT_ACADMIC_TIMELINE_OPTIONS?.length < i + 1
                        ),
                    }
                    return (
                        <TimelineItem key={i}>
